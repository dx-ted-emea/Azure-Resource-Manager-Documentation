...
## Authentication
Authentication against the Azure Resource Manager is achieved using a Service Principal. A complete walkthrough can be found in the [ARM Authentication](ARM/Authentication.md) section in this repository. 
